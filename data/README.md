...
- victoriaParkDataset.mat is retrived from the [Matlab website](https://www.mathworks.com/help/nav/ug/ekf-based-landmark-slam.html). More alligned with the raw data. Lidar scans are however allready processed into range-bearing tree detections and does not contain timestamps. In the  Matlab implementation, Lidar scans are interpreted as synced with the first preceding odometry reading. 
