...
def nonlinear_batch_slam_example_with_and_without_landamrks():
    ...
    eta_0 = np.hstack([
        x0,
        np.zeros(2 * num_landmarks)  # m0, m1, ... (no prior info)
    ])
    ...
    # fig.savefig('figures/slam_nonlinear_with_landmarks_lie_mapping.pdf', bbox_inches='tight')
    # fig2.savefig('figures/slam_nonlinear_without_landmarks_lie_mapping.pdf', bbox_inches='tight')
